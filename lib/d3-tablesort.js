...
(function(globals) {
    ...
    globals.TableSort = function(table, columns, data, dimensions) {
        ...
        outerTable
            ...
            .selectAll('span')
            .data(function(d, i) { 
                console.log(sort_column, i)
                if (d.sort_column && sort_column === -1) { sort_column = i; } return d.sort? [d]: ''; }).enter()
            .append('span')
    ...
    globals.TableSort.alphabetic = function(a, b, sort_order) {console.log(a, b, sort_order); return sort_order * a.localeCompare(b); }
    globals.TableSort.numeric = function (a, b, sort_order) { console.log(a, b, sort_order); return sort_order * (parseFloat(b) - parseFloat(a)); }
